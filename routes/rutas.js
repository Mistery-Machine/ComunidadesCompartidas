...
const rutasLista = (app) => {
    ...
    app.get("/editar-ruta/:id", requireAdmin, async (req, res) => {
    ...
    app.post("/actualizar-ruta/:id", requireAdmin, async (req, res) => {
        const datosRuta = {
    ...
    app.post("/eliminar-ruta/:id", requireAdmin, async (req, res) => {
